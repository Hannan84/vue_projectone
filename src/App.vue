...
<template>
  <section>
    <h1 style="text-align: center; margin: 40px 0px; font-size: 40px">
      Person Data
    </h1>
    <section class="content">
      <section class="person">
        <img :src="people[0].image" :alt="people[0].name" />
        <div>
          <h1>{{ people[0].name }}</h1>
      ...
      <section class="person">
        <img :src="people[1].image" :alt="people[1].name" />
        <div>
          <h1>{{ people[1].name }}</h1>
      ...
      <section class="person">
        <img :src="people[2].image" :alt="people[2].name" />
        <div>
          <h1>{{ people[2].name }}</h1>
